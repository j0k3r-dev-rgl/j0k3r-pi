...
export function registerCodeChangeSurfaceTool(pi: any) {
  pi.registerTool({
    ...
    parameters: Type.Object({
      ...
      implementation_mode: Type.Optional(Type.Union([Type.Literal('representative'), Type.Literal('exhaustive')], { description: 'Implementation reporting mode. Default: representative.' })),
      ...
      max_implementations: Type.Optional(Type.Number({ description: 'Maximum implementation entries when implementation_mode is exhaustive. Default: 50, max: 100.' })),
    ...
    async execute(_toolCallId: any, params: any, _signal: any, _onUpdate: any, ctx: any) {
      const surface = await buildCodeChangeSurface(ctx.cwd, {
        ...
        max_implementations: params.max_implementations,
