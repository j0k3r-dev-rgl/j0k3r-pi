...
function blockRangeFields(range: CanonicalJavaSymbolRecord['codeRange']): Pick<SymbolLocation, 'code_start_line' | 'code_start_column' | 'code_end_line' | 'code_end_column' | 'code_block_type'> {
