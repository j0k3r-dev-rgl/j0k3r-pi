...
export function createWorkspaceGraphState(input: Omit<WorkspaceGraphState, 'schemaVersion' | 'builderModelVersion' | 'builderFingerprint' | 'createdBy' | 'updatedAt'>): WorkspaceGraphState {
