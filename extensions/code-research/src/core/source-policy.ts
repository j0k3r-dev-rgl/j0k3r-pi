...
export const SUPPORTED_GRAPH_SOURCE_EXTENSIONS = new Set(['.ts', '.tsx', '.js', '.jsx', '.mjs', '.cjs', '.java', '.go']);
...
export function detectGraphLanguage(filePath: string): 'ts' | 'js' | 'java' | 'go' | undefined {
